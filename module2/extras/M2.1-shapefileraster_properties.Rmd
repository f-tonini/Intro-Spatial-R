...
```{r Some initializations: set working directory/path to data}
...
```{r Example: Colorado Plateau Boundary}
...
```{r Example: North American States}
...
```{r Example: Cities in the Colorado Plateau}
...
```{r Example: NHD streams and rivers}
...
```{r load bands from multi-band raster}
