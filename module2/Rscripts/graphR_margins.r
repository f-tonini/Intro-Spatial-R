	...
	plot(rnorm(n=20),ylim=c(-2.0,2.0),xlim=c(1,20))  # simple plot so show how lines are oriented in plot area
    ...
    mtext("Margins", side=3, line=2, cex=1.5, col="darkgreen")  
    mtext("par(mar=c(5,4,4,2) + 0.1)", side=3, line=1, cex=1, col="darkgreen")  
	
	mtext("Line 0", side=4, line=0, adj=1.0, cex=1, col="darkgreen")  
	mtext("Line 1", side=4, line=1, adj=1.0, cex=1, col="darkgreen")  	
	...
	mtext("Line 0", side=1, line=0, adj=1.0, cex=1, col="darkgreen")  
	mtext("Line 1", side=1, line=1, adj=1.0, cex=1, col="darkgreen")  
	mtext("Line 2", side=1, line=2, adj=1.0, cex=1, col="darkgreen")  
	mtext("Line 3", side=1, line=3, adj=1.0, cex=1, col="darkgreen")  
	mtext("Line 4", side=1, line=4, adj=1.0, cex=1, col="darkgreen") 
    ...
    # margins.  
    mtext("Outer Margin Area", side=3, line=1, cex=1.5, col="blue", outer=TRUE)  # default for series is side=1, not 3
    mtext("par(oma=c(3,3,3,3))", side=3, line=2, cex=1, col="blue", outer=TRUE)  
    mtext("Line 0", side=3, line=0, adj=0.0, cex=1, col="blue", outer=TRUE)  
    mtext("Line 1", side=3, line=1, adj=0.0, cex=1, col="blue", outer=TRUE)  
    mtext("Line 2", side=3, line=2, adj=0.0, cex=1, col="blue", outer=TRUE)  
    box("outer", col="blue")  
