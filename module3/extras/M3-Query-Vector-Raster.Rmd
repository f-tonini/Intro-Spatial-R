...
```{r plot deer units based on totals}
...
all.equal(proj4string(deer_unit), proj4string(ndvi500m.wgs84))
```
...
```{r calculate values for management}
# Calculate the mean
